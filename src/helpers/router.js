...
// meta.role: public = anyone, member = any Discord session, admin = role admin
// meta.nav = false hides the nav links, meta.bar = false hides the whole app bar
export const router = createRouter({
    ...
    routes: [
        ...
        { path: '/profile', component: ProfileView, meta: { role: 'member' } },
...
router.beforeEach(async (to) => {
    ...
    if (to.meta.role === 'admin' && auth.me?.role !== 'admin') {
        return '/profile';
    }
});
